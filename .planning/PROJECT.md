...
- **Module strategy**: Single Go module (`github.com/ai8future/chassis-go/v6`), not multi-module. Split into separate repos only if a single package needs a breaking change that doesn't affect others.
